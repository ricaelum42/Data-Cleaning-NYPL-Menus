DROP DATABASE IF EXISTS NYPL_Menus;

CREATE DATABASE IF NOT EXISTS NYPL_Menus;
...
LOAD DATA LOCAL INFILE '../Python/dish-clean.csv'
INTO TABLE dish 
...
LOAD DATA LOCAL INFILE '../Python/menu-clean.csv'
INTO TABLE menu 
FIELDS TERMINATED BY '\t'  
LINES TERMINATED BY '\n' 
IGNORE 1 ROWS;
...
LOAD DATA LOCAL INFILE '../Python/menupage-clean.csv'
INTO TABLE menupage 
FIELDS TERMINATED BY '\t'  
LINES TERMINATED BY '\n' 
IGNORE 1 ROWS;
...
LOAD DATA LOCAL INFILE '../Python/menuItem-clean.csv'
INTO TABLE menuItem
FIELDS TERMINATED BY '\t'  
LINES TERMINATED BY '\n' 
IGNORE 1 ROWS;
...
SELECT * FROM dish WHERE lowest_price > highest_price LIMIT 10;
